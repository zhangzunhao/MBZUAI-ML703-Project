...
class Solver(object):
    def __init__(self, config, svhn_loader, mnist_loader):
        ...
        self.g12 = None;  self.g21 = None;  self.d1 = None;  self.d2 = None
        self.g_optimizer = None;   self.d_optimizer = None
        
        self.use_reconst_loss = False
        ...
        for step in range(self.train_iters+1):
            ...
            if (step+1) % self.log_step == 0:
                print('Step [%d/%d], d_real_loss: %.4f, d_mnist_loss: %.4f,'
                      'd_svhn_loss: %.4f, d_fake_loss: %.4f, g_loss: %.4f' 
