...
from model.u2netfast_seg import U2NETFAST
...
ITER_SIZE = 1
NUM_WORKERS = 4
DATA_DIRECTORY = './Desktop/AdaptSegNet/dataset/GTA5'
DATA_LIST_PATH = './Desktop/AdaptSegNet/dataset/gta5_list/train.txt'
IGNORE_LABEL = 255
INPUT_SIZE = '640,360'
INPUT_SIZE_TARGET = '512, 256'
DATA_DIRECTORY_TARGET = './Desktop/AdaptSegNet/dataset/CityScape/leftImg8bit_trainvaltest'
DATA_LIST_PATH_TARGET = './Desktop/AdaptSegNet/dataset/cityscapes_list/train.txt'

NUM_CLASSES = 19
NUM_STEPS = int(50000 / BATCH_SIZE)
NUM_STEPS_STOP = int(50000 / BATCH_SIZE)  # early stopping
POWER = 0.9
RANDOM_SEED = 1234
RESTORE_FROM = 'http://vllab.ucmerced.edu/ytsai/CVPR18/DeepLab_resnet_pretrained_init-f81d91e8.pth'
SAVE_NUM_IMAGES = 2
SAVE_PRED_EVERY = 5000
SNAPSHOT_DIR = './Desktop/AdaptSegNet/snapshots_u2net'
...
def main():
    ...
    # Create network
    if args.model == 'U2NET':
        model = U2NETFAST(out_ch=args.num_classes)
    ...
    model_D1.train();    model_D1.cuda()
    model_D2.train();    model_D2.cuda()
    ...
    targetloader = data.DataLoader(cityscapesDataSet(args.data_dir_target, args.data_list_target,
                                                     ...
                                                     mirror=args.random_mirror, mean=IMG_MEAN, set=args.set),                                                     
                                   batch_size=args.batch_size, shuffle=True, num_workers=args.num_workers, pin_memory=True)
    ...
    for i_iter in range(args.num_steps):
        ...
        for sub_i in range(args.iter_size):
            ...
            loss_seg3 = loss_calc(pred3, labels)
            loss_seg4 = loss_calc(pred4, labels)
            loss = loss_seg1 + loss_seg2 + loss_seg3 + loss_seg4
            ...
            pred_target1, pred_target2, _ , _= model(images)
