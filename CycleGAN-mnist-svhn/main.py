...
if __name__ == '__main__':
    ...
    #parser.add_argument('--use_reconst_loss', required=True, type=str)
    #parser.add_argument('--use_labels',       required=True, type=str)    
    ...
    # misc
    parser.add_argument('--model_path',  type=str, default='./models_FF')
    parser.add_argument('--sample_path', type=str, default='./samples_FF')
