...
parser.add_argument('--content_dir', type=str, default='./mnist',
                    help='Directory path to a batch of content images')

parser.add_argument('--style', type=str, 
                    help='File path to the style image, or multiple style images separated\
                     by commas if you want to do style interpolation or spatial control')
parser.add_argument('--style_dir', type=str, default='./svhn',
...
parser.add_argument('--alpha', type=float, default=1.0,
                    help='The weight that controls the degree of stylization. between 0 and 1')
...
with tqdm(total=len(content_paths)) as pbar:
    for content_path in content_paths:
        if do_interpolation:  # one content image, N style image
            ...
            img_content = Image.open(str(content_path)).convert('RGB')
            W, H = img_content.size
            content = content_tf(img_content)
            ...
            output = F.upsample_bilinear(output, size=(H, W))
            output = output.cpu()
